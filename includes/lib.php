...
load_theme_textdomain( 'CFAStudio', TEMPLATEPATH . '/languages' );
$locale = get_locale();
...
function blankslate_get_page_number() {
    if (get_query_var('paged')) {
        echo ' | ' . __( 'Page ' , 'CFAStudio') . get_query_var('paged');
    }
}
...
function blankslate_register_menus() {
    register_nav_menus(
        array( 'main-menu' => __( 'Main Menu', 'CFAStudio' ))
    );
}
...
<div class="comment-meta"><?php printf(__('Posted %1$s at %2$s <span class="meta-sep"> | </span> <a href="%3$s" title="Permalink to this comment">Permalink</a>', 'CFAStudio'),
get_comment_date(),
get_comment_time(),
'#comment-' . get_comment_ID() );
edit_comment_link(__('Edit', 'CFAStudio'), ' <span class="meta-sep"> | </span> <span class="edit-link">', '</span>'); ?></div>
...
'reply_text' => __('Reply','CFAStudio'),
'login_text' => __('Log in to reply.','CFAStudio'),
'depth' => $depth,
...
function blankslate_custom_pings($comment, $args, $depth) {
    ...
    printf(__('By %1$s on %2$s at %3$s', 'CFAStudio'),
        get_comment_author_link(),
        get_comment_date(),
        get_comment_time() );
    
    edit_comment_link(__('Edit', 'CFAStudio'), ' <span class="meta-sep"> | </span> <span class="edit-link">', '</span>');
