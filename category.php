...
<div id="content">
<?php the_post(); ?>
<h1 class="page-title"><?php _e( 'Category Archives for', 'CFAStudio' ) ?> <span><?php single_cat_title() ?></span></h1>
...
<span class="cat-links"><?php printf( __( 'Also posted in %s', 'CFAStudio' ), $blankslate_cats ) ?></span>
<span class="meta-sep"> | </span>
<?php endif ?>
